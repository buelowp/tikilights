...
#line 1 "/Users/pete/Projects/tikilights/src/tikilights.ino"
#include <FastLED.h>
#include <SunSet.h>
...
void setup();
void loop();
#line 6 "/Users/pete/Projects/tikilights/src/tikilights.ino"
#define APP_VERSION			79
...
bool validRunTime()
{
    ...
    if ((g_minsPastMidnight >= g_sunset) && (g_minsPastMidnight < 1440))
        return true;
